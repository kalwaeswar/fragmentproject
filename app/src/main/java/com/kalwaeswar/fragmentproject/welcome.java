...
public class welcome extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getParentFragmentManager().setFragmentResultListener("editTextText11", this, new FragmentResultListener() {
            @Override
            public void onFragmentResult(@NonNull String requestKey, @NonNull Bundle result) {
                String data4=result.getString("df100");
                TextView textview4=view.findViewById(R.id.editTextText11);
